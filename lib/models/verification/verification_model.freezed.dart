...
abstract class $VerificationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int code, String email});
}
...
class _$VerificationModelImpl implements _VerificationModel {
  const _$VerificationModelImpl({required this.code, required this.email});
...
// Represents the code as an integer
  ...
  @override
  String toString() {
    return 'VerificationModel(code: $code, email: $email)';
  }
...
abstract class _VerificationModel implements VerificationModel {
  const factory _VerificationModel(
      ...
      required final String email}) = _$VerificationModelImpl;
