...
class DisplayCenterProduct {
  ...
  // From JSON
  factory DisplayCenterProduct.fromJson(Map<String, dynamic> json) {
    return DisplayCenterProduct(
      id: json['id'],
      name: json['name'],
      ...
      colorList: (json['colorList'] as List)
          ...
          .toList(),
      sizeList: json['sizeList'] != null
          ? (json['sizeList'] as List)
