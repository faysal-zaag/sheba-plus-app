            ...
            children: [
              HomeServiceCard(
                contents: [
                  Obx(
                    () => Text(
                      ...
                      style: Theme.of(context).textTheme.titleLarge?.copyWith(
                            color:
                                homeController.selectedService.value == service.id
                                    ? AppColors.primary
                                    : AppColors.black,
                          ),
                    ),
                  ...
                  4.kH,
                  Obx(() => Text(
                    homeController.selectedService.value == service.id ? service.description : service.description.split("\n\n").first,
