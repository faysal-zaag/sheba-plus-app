    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(PhosphorIcons.calendar(), color: AppColors.paragraph, size: 18,),
                      4.kW,
                      Text(
                        "10 Jan, 2023",
                        style: Theme.of(context)
          ...
          8.kH,
          Text("View Details", style: Theme.of(context).textTheme.displayMedium?.copyWith(fontSize: 12, color: AppColors.primary),)
        ],
      ),
    );
  }
